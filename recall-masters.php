...
// Definitions.
if ( ! defined( 'RECALL_MASTERS_VER' ) ) { define( 'RECALL_MASTERS_FILE', '1.0.2' ); }
...
class Recall_Masters {
	...
	public function __construct() {
		...
		$this->recall_masters_options  = new Recall_Masters_Shortcodes();
		$this->recall_masters_options  = new Recall_Masters_TinyMCE();
